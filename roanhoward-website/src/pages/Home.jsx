...
export default function Home() {
  return (
    <>
      <img className="full-width-image" src="/Images/Roan_alaska.JPG" alt="Banner" loading="eager" fetchPriority="high" />
      <div className="home-container">
        <div className="profile-block">
          <img className="profile-image" src="/Images/New_Face.jpeg" alt="Roan Howard" loading="lazy" />
        </div>
        <div className="about-section">
          ...
          <p className="about-text">
            ...
            I’m a 21-year-old junior at Stanford University, majoring in Computer Science with a concentration in Artificial Intelligence and minoring in Art Practice.
            I'm constantly hopping between ideas and thrive in the spaces where my interests intersect, where culture and technology come together.<br /> <br />
